...
.call(this), function (a) {
	...
	b.serverURL = "https://sharpic-dev.herokuapp.com",
	...
	b._request = function (a) {
		...
		if ("batch" !== c && "classes" !== c && "events" !== c && "files" !== c && "functions" !== c && "login" !== c && "logout" !== c && "push" !== c && "requestPasswordReset" !== c && "rest_verify_analytics" !== c && "users" !== c && "jobs" !== c && "config" !== c && "sessions" !== c && "upgradeToRevocableSession" !== c)
			throw "Bad route: '" + c + "'.";
		var j = b.serverURL;
		return "/" !== j.charAt(j.length - 1) && (j += "/"),
		j += "1/" + c,
		d && (j += "/" + d),
		e && (j += "/" + e),
		i = b._.clone(i || {}),
		"POST" !== f && (i._method = f, f = "POST"),
		b._.isUndefined(g) && (g = b._useMasterKey),
		i._ApplicationId = b.applicationId,
		g ? i._MasterKey = b.masterKey : i._JavaScriptKey = b.javaScriptKey,
		i._ClientVersion = b.VERSION,
...
(this), function (root) {
	...
	if (!Storage.async && !Storage.getItem) {
		...
		Storage.clear = function () {
			for (var a in memMap)
				memMap.hasOwnProperty(a) && delete memMap[a]
		}
	}
...
(this), function (a) {
	...
	b.ACL.prototype.setRoleReadAccess = function (a, d) {
		if (a instanceof b.Role && (a = a.getName()), c.isString(a))
			return void this.setReadAccess("role:" + a, d);
		throw "role must be a Parse.Role or a String"
	},
	b.ACL.prototype.setRoleWriteAccess = function (a, d) {
		if (a instanceof b.Role && (a = a.getName()), c.isString(a))
			return void this.setWriteAccess("role:" + a, d);
		throw "role must be a Parse.Role or a String"
	}
}
(this), function (a) {
...
(this), function (a) {
	...
	c.extend(b.Promise.prototype, {
		...
		reject : function (a) {
			...
			this._rejected = !0,
			this._error = a,
			b._arrayEach(this._rejectedCallbacks, function (b) {
				b(a)
			}),
			this._resolvedCallbacks = [],
			this._rejectedCallbacks = []
...
(this), function (a) {
	...
	g = function (a, c) {
		...
		return e.onloadend = function () {
			if (2 !== e.readyState)
				return void d.reject(new b.Error(b.Error.FILE_READ_ERROR, "Error reading file."));
			var a = e.result,
...
(this), function (a) {
						...
						return b._request({
							...
							data : {
								requests : c.map(a, function (a) {
									return {
										method : "DELETE",
										path : "/parse/classes/" + a.className + "/" + a.id
									}
								})
							}
						})
	...
	c.extend(b.Object.prototype, b.Events, {
		...
		_toFullJSON : function (a) {
			...
			c.has(this, "createdAt") && (d.createdAt = c.isDate(this.createdAt) ? this.createdAt.toJSON() : this.createdAt),
		...
		_rebuildAllEstimatedData : function () {
			...
			b._arrayEach(this._opSetQueue, function (c) {
				a._applyOpSet(c, a.attributes),
				b._objectEach(c, function (b, c) {
		...
		set : function (a, d, e) {
			...
			b._objectEach(f, function (a, b) {
				if (g.constructor.readOnlyAttributes && g.constructor.readOnlyAttributes[b])
					throw new Error("Cannot modify readonly key: " + b)
			}),
...
(this), function (a) {
	...
	c.extend(b.Collection.prototype, b.Events, {
		...
		add : function (a, d) {
			...
			for (e = 0; g > e; e++)
				(h = a[e]).on("all", this._onModelEvent, this), this._byCid[h.cid] = h, h.id && (this._byId[h.id] = h);
		...
		reset : function (a, c) {
			...
			return a = a || [],
			c = c || {},
			b._arrayEach(this.models, function (a) {
...
(this), function (a) {
	...
	b.User = b.Object.extend("_User", {
			...
			save : function (a, d, e) {
				var f,
				g;
				c.isObject(a) || c.isNull(a) || c.isUndefined(a) ? (f = a, g = d) : (f = {}, f[a] = d, g = e),
				g = g || {};
				var h = c.clone(g);
				return h.success = function (a) {
			...
			_upgradeToRevocableSession : function (a) {
				if (a = a || {}, !b.User.current())
					return b.Promise.as()._thenRunCallbacks(a);
			...
			current : function () {
				if (b.Storage.async)
					return b.User._currentAsync(), b.User._currentUser;
			...
			enableRevocableSession : function (a) {
				...
				!b._isNode && b.User.current() ? b.User.current()._upgradeToRevocableSession(a) : b.Promise.as()._thenRunCallbacks(a)
			},
...
(this), function (a) {
	...
	b.Query.prototype = {
		...
		toJSON : function () {
			...
			b._objectEach(this._extraOptions, function (b, c) {
				a[c] = b
			}),
			a
		},
		...
		addAscending : function (a) {
			...
			b._arrayEach(arguments, function (a) {
		...
		addDescending : function (a) {
			...
			b._arrayEach(arguments, function (a) {
				Array.isArray(a) && (a = a.join()),
				d._order = d._order.concat(c.map(a.replace(/\s/g, "").split(","), function (a) {
							return "-" + a
						}))
			}),
			this
		...
		select : function () {
			...
			b._arrayEach(arguments, function (b) {
